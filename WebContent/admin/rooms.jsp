                                ...
                                <div class="table-responsive">
                                    <div id="file_export_wrapper"
                                        ...
                                        <table id="file_export"
                                            class="table table-striped table-bordered display dataTable" role="grid"
                                            aria-describedby="file_export_info">
                                            <thead>
                                                <tr role="row">
                                                    <th class="sorting_asc" tabindex="0" aria-controls="file_export"
                                            ...
                                            <tbody>
                                                <s:iterator value="dataList" var="room">
                                                    <tr>
                                                        ...
                                                        <td class='<s:if test="%{#room.status == 'Open'}">text-success</s:if><s:elseif test="%{#room.status == 'Closed'}">
														...
														<td><span
															...
															style="text-align: left; display: table-cell; min-width: 10px; padding-right: 10px;">
																<form action="approveRequest" method="POST">
																	...
																	<button type="submit"
																		class="btn btn-sm btn-icon btn-pure btn-outline delete-row-btn"
																		data-toggle="tooltip" data-original-title="Accecpt">
